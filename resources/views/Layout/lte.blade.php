...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="/admin/users"><i class="fa fa-user"></i> <span>User</span></a></li>
        <li><a href="/admin/team"><i class="fa fa-group"></i> <span>Team</span></a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="https://adminlte.io">AR Production</a>.</strong> All rights
    reserved.
  </footer>
